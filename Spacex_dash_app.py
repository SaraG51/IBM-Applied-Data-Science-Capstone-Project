...
# Create list of unique launch site names
...
def scatter(entered_site, payload):
    ...
    if entered_site == 'ALL': # return the outcomes for all sites as a scatterplot
        ...
        # return the outomes scatter plot for the selected site
